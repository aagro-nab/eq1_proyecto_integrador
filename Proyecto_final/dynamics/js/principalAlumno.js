...
async function changeView(view) {
    ...
    switch (view) {
        case 'Foros':
            ...
            buttons[2].innerHTML = "<i class='fas fa-sign-in-alt'></i><span class='button-text'> Entrar a un foro</span>";
            buttons[3].innerHTML = "<i class='fas fa-sign-out-alt'></i><span class='button-text'> Salir de un foro</span>";
